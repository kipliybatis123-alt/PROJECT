const Hero = () => {
  return (
    <section
      id="home"
      style={{ fontFamily: "sans-serif", background: "#f8f7f4", paddingTop: "60px" }}
    >
      {/* Hero Split */}
      <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", minHeight: "420px" }}>
          ...
          <div>
            ...
            <h1
              style={{
                ...
                lineHeight: 1.05, letterSpacing: "-1.5px", color: "#0b0b0b", margin: 0,
              }}
            >
              ...
              <a href="#kontak">
                <button
                  style={{
                    ...
                    fontSize: "13px", fontWeight: 500, cursor: "pointer", transition: "opacity 0.2s",
                  }}
              ...
              <a href="#produk">
                <button
                  style={{
                    ...
                    border: "1px solid #e8e6e0", borderRadius: "20px",
                    padding: "10px 24px", fontSize: "13px", cursor: "pointer", transition: "border-color 0.2s",
                  }}
        ...
        >
          {[
            ...
            <div
              key={val}
              style={{ background: "#fff", borderRadius: "16px", padding: "20px 24px", border: "0.5px solid #e8e6e0" }}
            >
